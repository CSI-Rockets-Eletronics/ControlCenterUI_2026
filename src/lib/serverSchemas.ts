...
export const fsStateRecordSchema = z.object({
  ...
  state: fsStateSchema,
  gn2_drain: z.boolean().optional().default(false),
  gn2_fill: z.boolean().optional().default(false),
  lox_fill: z.boolean().optional().default(false),
  lox_disconnect: z.boolean().optional().default(false),
  depress: z.boolean().optional().default(false),
  press_pilot: z.boolean().optional().default(false),
  run: z.boolean().optional().default(false),
  igniter: z.boolean().optional().default(false),
  ereg_power: z.boolean().optional().default(false),
  gn2_abort: z.boolean().optional().default(false),
  pilot_vent: z.boolean().optional().default(false),
  dome_pilot_open: z.boolean().optional().default(false),
  five_two: z.boolean().optional().default(false),
  water_suppression: z.boolean().optional().default(false),
});
...
export const fsLoxGn2TransducersRecordSchema = z.object({
  ...
  pilot_pres: z.number(),
  qd_pres: z.number(),
  ereg_closed: z.boolean().optional().default(false),
  ereg_stage_1: z.boolean().optional().default(false),
  ereg_stage_2: z.boolean().optional().default(false),
...
export const radioGroundRecordSchema = z.object({
  ...
  gps_fix: z.boolean().optional().default(false),
